...
namespace E_School_Diary.Data.DB.Contracts
{
    public interface IDatabaseContext
    {
        ...
        DbSet<AspNetRoles1> AspNetRoles1 { get; set; }
        DbSet<AspNetUserClaim> AspNetUserClaims { get; set; }
        DbSet<AspNetUserClaims1> AspNetUserClaims1 { get; set; }
        DbSet<AspNetUserLogin> AspNetUserLogins { get; set; }
        DbSet<AspNetUserLogins1> AspNetUserLogins1 { get; set; }
        DbSet<AspNetUserRole> AspNetUserRoles { get; set; }
        DbSet<AspNetUser> AspNetUsers { get; set; }
        DbSet<AspNetUsers1> AspNetUsers1 { get; set; }
